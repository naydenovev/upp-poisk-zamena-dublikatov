...
Процедура ПередОткрытием(Отказ, СтандартнаяОбработка)
	...
	НадписьСообщение = НСтр("ru='В справочнике ""';uk='У довіднику ""'")+мИскомыйОбъектПоискаДублей.Метаданные().Представление()+НСтр("ru='"" найдены дублирующие элементы."
"Отменить ввод нового и выбрать элемент из списка?';uk='"" знайдені елементи, що дублюються."
"Скасувати введення нового і вибрати елемент зі списку?'");
